<div class="checkout-container py-5">
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    @if($step == 1)
                        ...
                        <div class="product-summary mb-4 p-3 bg-light rounded-3 d-flex align-items-center gap-3">
                            <div style="width: 60px; height: 60px; background: #fff; border-radius: 10px; display: flex; align-items: center; justify-content: center; border: 1px solid #eee;">
                                @if($product->image)
                        ...
                        <form wire:submit.prevent="nextStep">
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="name" class="form-control form-control-lg rounded-3" placeholder="Nguyễn Văn A" required>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold">Số điện thoại / WhatsApp (Không bắt buộc)</label>
                                <input type="text" wire:model="whatsapp" class="form-control form-control-lg rounded-3" placeholder="0123456789">
                            </div>
                            <button type="submit" class="btn btn-primary btn-lg w-100 py-3 rounded-3 fw-bold shadow-sm">Tiếp tục thanh toán <i class="fa-solid fa-arrow-right ms-2"></i></button>
                        </form>
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-md-5 text-center">
                                ...
                                <div class="p-2 bg-white rounded-3 shadow-sm border border-2 border-primary d-inline-block">
                                    <img src="{{ $qr_url }}" alt="VietQR" class="img-fluid" style="max-width: 220px; border-radius: 8px;">
                                </div>
                                <div class="mt-2 small text-primary fw-bold"><i class="fa-solid fa-camera"></i> Mở App Ngân hàng quét QR</div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="bg-light p-3 rounded-3 mb-3 border border-dashed">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <span class="fw-bold text-uppercase p-1 bg-warning-subtle border border-warning rounded px-2">{{ $order_code }} {{ Str::slug($name) }}</span>
                                    </div>
                                </div>

                                <div class="form-check p-3 bg-light rounded-3 border mb-4">
                                    <input class="form-check-input ms-0 me-2" type="checkbox" wire:model="is_paid" id="is_paid">
                                ...
                                <button wire:click="confirmPayment" class="btn btn-primary btn-lg w-100 py-3 rounded-3 fw-bold shadow-sm">Xác nhận Đã thanh toán <i class="fa-solid fa-check-circle ms-2"></i></button>
                            </div>
                        </div>
                    ...
                    @elseif($step == 3)
                        ...
                        <div class="text-center py-5">
                            <div class="mb-4">
                                <div class="success-icon animate__animated animate__zoomIn" style="width: 100px; height: 100px; background: #dcfce7; color: #16a34a; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; font-size: 3rem;">
                                    <i class="fa-solid fa-check"></i>
                                </div>
                            </div>
                            <h3 class="fw-bold mb-2">Thanh toán thành công!</h3>
                            <div class="mb-3">
                                <span class="text-muted">Mã đơn hàng:</span> <strong class="text-primary">{{ $order_code }}</strong>
                            </div>
                            <p class="text-muted">Đơn hàng của bạn đang được hệ thống xử lý.<br>Thông tin tài khoản sẽ được gửi vào Email: <strong>{{ $email }}</strong> sau 5-10 phút.</p>
                            ...
                            ">
                                <p class="small text-muted mb-2">Đang chuyển về trang chủ sau <span id="countdown" class="fw-bold text-primary">5</span> giây...</p>
                ...
                <div class="card-footer bg-white border-top-0 pb-4 text-center px-4">
                    <p class="small text-muted mb-0"><i class="fa-solid fa-shield-halved text-success"></i> Mọi thông tin thanh toán đều được bảo mật tuyệt đối.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <style>
        ...
        .animate__zoomIn { animation: zoomIn 0.5s; }
    </style>
</div>
