<div class="py-5 bg-light" style="min-height: calc(100vh - 200px);">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden chat-container-page"
                    wire:poll.3000ms="markAsRead">
                    <div
                        class="chat-header-page p-4 bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="chat-body-page p-4 bg-white" id="chat-body-full"
                        style="height: 500px; overflow-y: auto; display: flex; flex-direction: column; gap: 15px;">
                    ...
                    <form class="chat-footer-page p-4 bg-light border-top" wire:submit.prevent="sendMessage">
                        <div class="input-group">
                            <input type="text" wire:model.defer="message"
                                class="form-control form-control-lg border-0 shadow-none ps-0 bg-transparent"
                                placeholder="Nhập tin...">
                            <button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm ms-2"
                                wire:loading.attr="disabled">
                                <span wire:loading.remove><i class="fa-solid fa-paper-plane me-2"></i> Gửi</span>
    ...
    <style>
        ...
        .status-circle.online {
            background: #4dfa3c;
            box-shadow: 0 0 10px rgba(77, 250, 60, 0.5);
        }
