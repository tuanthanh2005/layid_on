...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="page-title mb-0">Thêm Thủ thuật Gemini</h1>
...
<form action="{{ route('admin.gemini-tricks.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Nhập tiêu đề..." required>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-muted">Ảnh minh họa</label>
                    ...
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" name="status" id="trick-status" value="1" checked>
                        <label class="form-check-label fw-bold" for="trick-status">Công khai</label>
                    </div>

                    <button type="submit" class="btn btn-primary btn-lg w-100 fw-bold">
                        <i data-lucide="send" size="20" class="me-2"></i> Lưu và Đăng
                    </button>
                </div>
            </div>
        </div>
