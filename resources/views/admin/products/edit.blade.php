                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="badge_text" class="form-control" value="{{ $product->badge_text }}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Thứ tự hiển thị (STT)</label>
                            <input type="number" name="order_index" class="form-control" value="{{ $product->order_index }}">
                        </div>
                     ...
                     <div class="mb-4">
                        ...
                        @if($product->image)
                        <img src="{{ $product->image }}" alt="" style="height: 100px; border-radius: 8px; margin-bottom: 10px;">
                        @endif
